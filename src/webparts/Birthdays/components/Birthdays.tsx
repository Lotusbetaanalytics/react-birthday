      ...
      <div className={styles.happyBirthday}
        ...
        <div className={styles.container}>
          <WebPartTitle displayMode={this.props.displayMode}
            ...
            updateProperty={this.props.updateProperty} className={styles.aligment}  />


{/* {this.state.showConfetti == true ? //            width={300} height={100}

<Confetti style={{ width: "100%", height: "90%", marginTop: "10%" }}
/>
: ''
} */}
